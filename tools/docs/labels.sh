...
declare -A LABEL_COLORS=(
    ...
    ["tests"]="A2EEEF"               # Light cyan - feature
    ...
    # Project Specific in labeler.yml
    ["sdk"]="A2EEEF"               # Light cyan - feature
    ["plugin"]="A2EEEF"               # Light cyan - feature
    ["api"]="A2EEEF"               # Light cyan - feature
    ["ui"]="A2EEEF"               # Light cyan - feature
...
declare -A LABEL_DESCRIPTIONS=(
    ...
    # Project specific from labeler.yml
    ["sdk"]="SDK changes"
